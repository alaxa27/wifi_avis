...
var Comment = exports.Comment = function (_HTMLElement) {
...
var _websocket_protocol = __webpack_require__(1);
...
var _Comment = __webpack_require__(0);
...
var CommentsManager = exports.CommentsManager = function () {
    ...
    _createClass(CommentsManager, [{
        key: 'add',
        value: function add(author, text) {
            var comment = new _Comment.Comment(author, text);
...
var _chartMin = __webpack_require__(2);
...
var DisplayManager = exports.DisplayManager = function () {
    ...
    _createClass(DisplayManager, [{
        key: 'update',
        value: function update(question, results) {
                ...
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    ...
                    try {
                        for (var _iterator = questions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            ...
                            _this2.displayManager.update(question, question.results);
                        }
                    } catch (err) {
                        _didIteratorError = true;
                        _iteratorError = err;
...
var _StagedComment = __webpack_require__(12);

var _SelectedComment = __webpack_require__(11);
...
var SelectManager = exports.SelectManager = function () {
    ...
    _createClass(SelectManager, [{
        ...
        key: 'appendComment',
        value: function appendComment(author, text) {
            var _this3 = this;

            var comment = new _StagedComment.StagedComment(author, text);
            ...
            comment.validateButton.addEventListener('click', function () {
                ...
                xhr.onreadystatechange = function () {
                    if (this.readyState === XMLHttpRequest.DONE) {
                        if (this.status === 200) {
                            comment.remove();
                            selectedCommentsContainer.appendFirst(new _SelectedComment.SelectedComment(author, text));
                        } else {
                            window.alert(gettext("Could not send comment, please try again."));
                        }
                    }
...
var _CommentsManager = __webpack_require__(4);

var _CurrentManager = __webpack_require__(3);

var _DisplayManager = __webpack_require__(5);

var _ResultsManager = __webpack_require__(6);

var _SelectManager = __webpack_require__(7);
...
var Display = exports.Display = function (_HTMLElement) {
    _inherits(Display, _HTMLElement);
            ...
            var options = {
                ...
                animation: {
                    onComplete: function onComplete() {
                        ...
                        ctx.font = _chartMin.Chart.helpers.fontString(_chartMin.Chart.defaults.global.defaultFontSize, _chartMin.Chart.defaults.global.defaultFontStyle, _chartMin.Chart.defaults.global.defaultFontFamily);
...
var _Comment2 = __webpack_require__(0);
...
var SelectedComment = exports.SelectedComment = function (_Comment) {
    ...
    function SelectedComment(author, text) {
        _classCallCheck(this, SelectedComment);

        return _possibleConstructorReturn(this, (SelectedComment.__proto__ || Object.getPrototypeOf(SelectedComment)).call(this, author, text));
    }
...
var StagedComment = exports.StagedComment = function (_Comment) {
    ...
    function StagedComment(author, text) {
        _classCallCheck(this, StagedComment);

        return _possibleConstructorReturn(this, (StagedComment.__proto__ || Object.getPrototypeOf(StagedComment)).call(this, author, text));
    }
